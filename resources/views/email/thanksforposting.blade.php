...
<html>
    <head>
      <meta http-equiv="Content-Type" content="text/html charset=UTF-8" />
        ...
        <style>
            .shadow {
               -webkit-box-shadow: 8px 8px 10px -8px #2d3748;
               -moz-box-shadow: 8px 8px 10px -8px #2d3748;
                    box-shadow: 8px 8px 10px -8px #2d3748;
                    border-radius: 8px;
            }
            body{
...
<body style="background-image: linear-gradient(#2598B5, #A9DDE9); background-size:cover; background-repeat: no-repeat; height: 100vh;">
<table width="100%">
    <tr>
        <td class="esd-stripe" align="center">
            <table width="700" cellspacing="0" cellpadding="0" class="shadow" style="background-color:#edf2f7; padding: 22px;">
                <tr>
                    <td class="esd-stripe" align="left">
                        ...
                        <table style="background-color: transparent; padding: 18px; margin-top: 32px;" width="700" align="center">
                            <tr>
                                <td class="esd-stripe" align="center">  
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="esd-block-text es-p15t es-p10b" align="center">
                                                    <h3 style="font-size: 2.425rem; margin:0; font-weight: 400;">Hi John, Thanks</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="esd-block-text es-p15t es-p10b" align="center">
                                                    <p style="letter-spacing: .025rem; margin-bottom: 42px; font-size: 1.25rem;">You have successfully submited a job post. Keep kalm until the varification process is complete.</p>
                                                </td>
                                            </tr>
                        ...
                        <table>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="7684" align="left">
                                    <table class="es-footer-body" width="700" cellspacing="0" cellpadding="0" align="left">
                                        <tbody>
                                            <tr>
                                                <td class="esd-block-text es-p15t es-p10b" align="left">
                                                    <hr style="border-color: #edf2f7; margin-top: 90px;">
                                                </td>
                                            </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%" align="left">
                                                <img src="{{url('jh-logo.svg')}}" width="150">
                                            </td>
                                            <td width="50%" class="esd-block-text es-p15t es-p10b" align="right">
                                                <p style="margin: 0; color: #4a5568; font-weight: 700; letter-spacing: .025em; font-size: 1rem; line-height: 1.325rem;">&copy; jobsharbour.com</p>
                                                <p style="margin: 0; color: #4a5568; letter-spacing: .025em; font-size: 1rem; line-height: 1.325rem;">Guwahati, Assam</p>
                                            </td>
                                        </tr>
